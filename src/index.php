...
<body>
    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./images/rooms/IMG_70583.png">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./images/rooms/IMG_67761.png">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./images/rooms/0015.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./images/rooms/0004.jpg">
            </div>
        </div>
    </section>
    ...
    <section id="auth_section">
        ...
        <div class="logo " style="margin-right:55px; margin-top: 40px; ">
            <img class="bluebirdlogo"  style="margin-top: 30px;" src="./images/logo.png" alt="logo">
        </div>
