...
<body class="bg-light">
 ...
 <span class="badge rounded-pill bg-light">
  ...
  <secondary style="font-size :.875em ; ">
    <h6 class="text-gray-600 "> Vivanta , pune | 8.350 km from pune Airport </h6>
  </secondary>
...
Located in the heart of the city, our hotel is the ideal base for both leisure and business travelers</span>
                           ...
                           <div class="facilities mb-2">
                            ...
                            <span class="badge rounded-pill bg-light text-dark text-wrap lh-base">Break + Lunch + Dinner</span>
